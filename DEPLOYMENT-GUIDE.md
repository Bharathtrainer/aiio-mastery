# DEPLOYMENT GUIDE — NVIDIA AIIO Exam Mastery on GitHub Pages
...
3. Repository name: `aiio-mastery`
...
Your URLs will be:
- Landing page: **https://nbharathtrainer.github.io/aiio-mastery/**
- Simulator: **https://nbharathtrainer.github.io/aiio-mastery/simulator.html**

### Step 5: Connect to Custom Domain (Optional)
If you buy a domain like `aiiomastery.com`:
